...
test('test', async ({ page }) => {
  await page.goto('https://ilarionhalushka.github.io/jekyll-ecommerce-demo/,m,.m');
  ...
  // it will fail here
  await page.locator('.snipcart-textbox.snipcart__font--bold.snipcart__font--secondary.snipcart-form__select.snipcart-textbox--focus').click();
  // we want to fix
  ...
  await page.locator('iframe').contentFrame().getByRole('textbox', { name: 'MM/YY' }).fill('02/27');
